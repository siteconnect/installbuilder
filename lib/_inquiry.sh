...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Multizap Flow que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Multizap Flow selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Multizap Flow\n"
  printf "   [1] Atualizar Multizap Flow\n"
  printf "   [2] Deletar Multizap Flow\n"
  printf "   [3] Bloquear Multizap Flow\n"
  printf "   [4] Desbloquear Multizap Flow\n"
  printf "   [5] Alter. dominio Multizap Flow\n"
  printf "\n"
  read -p "> " option
